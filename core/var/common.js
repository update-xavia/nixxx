...
// import canvas from 'canvas'; // Disabled due to build issues
...
/**
 * Circle an image
 * Disabled due to canvas build issues
 */
function circle(image, x, y, radius) {
    throw new Error('Canvas circle function is disabled. Please install canvas dependency to use this feature.');
